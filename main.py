...
def generate_index_page(charts_dir):
    ...
    lines.append("    <div class='form-group'><label>Symbols, separated by commas<input type='text' name='symbols' placeholder='AAPL, MSFT...' required></label></div>")
    lines.append("    <div class='form-group'><label>Years of Past Data to train with    <input type='number' step='0.1' name='years' required></label></div>")
    lines.append("    <div class='form-group'><label>Days into the future to forecast    <input type='number' name='days' required></label></div>")
